                ...
                <div className="flex items-center justify-between px-3 sm:px-6 py-3 gap-3">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 sm:gap-3 hover:bg-slate-50 p-1.5 sm:pr-3 rounded-xl transition-colors border border-transparent hover:border-slate-200"
                        >
                            ...
                            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-primary-500 to-primary-700 text-white flex items-center justify-center shadow-md shrink-0">
